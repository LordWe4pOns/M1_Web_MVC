                ...
                <?php foreach ($users as $u): ?>
                    <tr class="border-t border-white/10 hover:bg-white/10">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="index.php?action=user_delete&id=<?= $u['user_id'] ?>" onclick="return confirm('Delete this user ?')" class="rounded-lg bg-red-500/80 hover:bg-red-600 text-white font-semibold px-3 py-1 transition">🗑️ Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
