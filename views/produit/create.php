...
<div class="bg-white/10 backdrop-blur-xl rounded-xl p-8 shadow-2xl border border-white/20 max-w-md w-full">
    <h1 class="text-3xl font-bold mb-6 text-center text-white">Create new product</h1>
    <form method="POST" class="space-y-4">
        ...
        <div>
            <label for="designation_p" class="block text-sm font-medium text-white">Designation:</label>
        ...
        <div>
            <label for="prix_ht" class="block text-sm font-medium text-white">Price without taxes:</label>
